...
HD_PWD='C:/Users/Andrei/Documents/Vivado Projects/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumator_1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumator_1bit.tcl
